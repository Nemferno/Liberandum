package org.xodia.multitaskgame.google.services;
...
public class GGameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static void showFailureDialog(Activity activity, int actResp,
        ...
        case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
            errorDialog = makeSimpleDialog(activity, GGameHelperUtils.getString(
                    activity, GGameHelperUtils.R_APP_MISCONFIGURED));
            break;
        case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
            errorDialog = makeSimpleDialog(activity, GGameHelperUtils.getString(
                    activity, GGameHelperUtils.R_SIGN_IN_FAILED));
            break;
        case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
            errorDialog = makeSimpleDialog(activity, GGameHelperUtils.getString(
                    activity, GGameHelperUtils.R_LICENSE_FAILED));
            break;
        default:
